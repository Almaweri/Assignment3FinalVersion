package edu.cse523.maged.assignment3finalversion;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (viewId == R.id.btnUpdate) {
                    ...
                    intent.putExtra("OperationType", m_Currentoperation);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == 555 && resultCode == RESULT_OK && null != data) {
                ...
                {
                    ((Product) productAdapter.getItem(m_CurrentItemIndex)).setName(data.getStringExtra("ProductName"));
                    ((Product) productAdapter.getItem(m_CurrentItemIndex)).setPrice(data.getStringExtra("ProductPrice"));
